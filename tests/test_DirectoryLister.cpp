...
//
// static const std::string NONASCII = "caf\xC3\xA9.txt";
//
...
// }
//
// static void test_generate_url_encodes_non_ascii()
// {
//     std::string html;
//     DirectoryLister::generate(ROOT + "/", "/", html);
//     assert(contains(html, "href=\"/caf%C3%A9.txt\""));
//     assert(!contains(html, "%FFFFFFC3"));
//     std::cout << "[OK] generate URL-encodes bytes above 0x7F correctly" << std::endl;
// }
//
...
//     test_generate_url_encodes_non_ascii();
